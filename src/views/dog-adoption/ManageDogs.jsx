...
const ManageDogs = () => {
    ...
    return (
      <div className="">
        ...
        <button
          className="custom-button-over-white-bg ml-[2.5rem] flex h-[3.0rem] w-full max-w-[11.0rem] flex-wrap items-center justify-center"
          type="button"
        ...
        <div className="flex flex-wrap">
          <div className="two-columns-right ml-[2.50rem] mr-[0rem] mt-[2rem] w-full pl-0 lg:w-1/2 lg:flex-grow">
